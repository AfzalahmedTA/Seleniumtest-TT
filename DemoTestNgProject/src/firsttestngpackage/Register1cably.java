...
public class Register1cably {
  ...
  public void TC_01() throws IOException,Exception{
	 ...
	 /* if(message1.isDisplayed() || message3.isDisplayed() || message2.isDisplayed()) {
	  ...
	  /*if(message2.isDisplayed()) {
		  ...
		  System.out.println("Scernaio fail");
		  sheet.getRow(i).createCell(6).setCellValue("fails");		  
	  }
	  */
	 ...
	 /* if(message3.isDisplayed()) {
		  System.out.println("scenario fails");
		  sheet.getRow(i).createCell(6).setCellValue("pass");
	  }
	  else {
		 System.out.println("scenario pass");
